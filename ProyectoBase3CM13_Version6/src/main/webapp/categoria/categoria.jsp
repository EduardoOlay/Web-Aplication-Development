            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-lin " href="./listaCategoria.jsp">Lista de Categorias</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="./categoria.jsp">Agregar Categoria</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="card">
            ...
            <div class="card-body table-responsive">
                <s:form action="almacenarCategoria">
                    ...
                    <div class="mb-3"></div>
                    <s:submit key="categoria.boton.guardar" class="btn btn-outline-succes"/>
                </s:form>
